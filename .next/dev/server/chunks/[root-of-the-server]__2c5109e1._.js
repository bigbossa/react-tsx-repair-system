...
"[project]/app/react-tsx-repair-system/app/api/users/import/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    try {
        ...
        if (!users || !Array.isArray(users) || users.length === 0) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$react$2d$tsx$2d$repair$2d$system$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                error: 'ไม่มีข้อมูลผู้ใช้ที่จะ import'
            }, {
                status: 400
            });
        }
        ...
        for(let i = 0; i < users.length; i++){
            ...
            try {
                ...
                const existingUser = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$react$2d$tsx$2d$repair$2d$system$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(checkQuery, [
                    username
                ]);
            ...
            WHERE username = $1
          `;
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$react$2d$tsx$2d$repair$2d$system$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(updateQuery, [
                        username,
                        password,
                        name,
                        roleValue,
            ...
            VALUES ($1, $2, $3, $4, $5, $6)
          `;
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$react$2d$tsx$2d$repair$2d$system$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(insertQuery, [
                        username,
                        password,
                        name,
                        roleValue,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2c5109e1._.js.map