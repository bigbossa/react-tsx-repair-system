...
"[project]/lib/auth-store.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function authenticateUser(username, password) {
    ...
    try {
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('SELECT iduser, usersname as username, site, username as user_login, password, department, userid, "Role" FROM useryc WHERE username = $1 AND password = $2 LIMIT 1', [
            username,
            password
        ]);
...
async function getUserByUsername(username) {
    try {
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('SELECT iduser, usersname as username, site, username as user_login, department, userid, "Role" FROM useryc WHERE username = $1 LIMIT 1', [
            username
        ]);
        if (result.rows.length === 0) {
            return null;
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2d$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/auth-store.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/server.js [app-route] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2d$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2d$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
async function POST(request) {
    try {
        const { username, password } = await request.json();
        const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2d$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["authenticateUser"])(username, password);
        if (!user) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__38d90d2b._.js.map