...
"[project]/app/react-tsx-repair-system/app/api/tickets/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, context) {
    try {
        ...
        const sampleResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$react$2d$tsx$2d$repair$2d$system$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryRepair"])('SELECT * FROM repairrequest LIMIT 5');
        ...
        let result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$react$2d$tsx$2d$repair$2d$system$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryRepair"])('SELECT * FROM repairrequest WHERE request_id = $1', [
            id
        ]);
        console.log('Try 1 (request_id):', result.rows.length);
        // If not found, try with "Request_ID" (capital)
        if (result.rows.length === 0) {
            result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$react$2d$tsx$2d$repair$2d$system$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryRepair"])('SELECT * FROM repairrequest WHERE "Request_ID" = $1', [
                id
            ]);
        ...
        // Try with asset_id
        if (result.rows.length === 0) {
            result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$react$2d$tsx$2d$repair$2d$system$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryRepair"])('SELECT * FROM repairrequest WHERE asset_id = $1', [
                id
            ]);
        ...
        if (result.rows.length === 0) {
            result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$react$2d$tsx$2d$repair$2d$system$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryRepair"])('SELECT * FROM repairrequest WHERE LOWER(request_id) = LOWER($1)', [
                id
            ]);
        ...
        // Try LIKE search
        if (result.rows.length === 0) {
            result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$react$2d$tsx$2d$repair$2d$system$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryRepair"])('SELECT * FROM repairrequest WHERE request_id ILIKE $1', [
                `%${id}%`
            ]);
...
async function PUT(request, context) {
    try {
        ...
        let oldTicketResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$react$2d$tsx$2d$repair$2d$system$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryRepair"])('SELECT "Status", username, request_id FROM repairrequest WHERE request_id = $1', [
            id
        ]);
        console.log('Try finding by request_id:', oldTicketResult.rows.length);
        // If not found, try with "Request_ID" (capital)
        if (oldTicketResult.rows.length === 0) {
            oldTicketResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$react$2d$tsx$2d$repair$2d$system$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryRepair"])('SELECT "Status", username, "Request_ID" as request_id FROM repairrequest WHERE "Request_ID" = $1', [
                id
            ]);
            console.log('Try finding by Request_ID:', oldTicketResult.rows.length);
        }
        // Try with asset_id
        if (oldTicketResult.rows.length === 0) {
            oldTicketResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$react$2d$tsx$2d$repair$2d$system$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryRepair"])('SELECT "Status", username, request_id FROM repairrequest WHERE asset_id = $1', [
                id
            ]);
        ...
        if (oldTicketResult.rows.length === 0) {
            oldTicketResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$react$2d$tsx$2d$repair$2d$system$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryRepair"])('SELECT "Status", username, request_id FROM repairrequest WHERE LOWER(request_id) = LOWER($1)', [
                id
            ]);
        ...
        if (data.Rep_info !== undefined) {
            // ดึงข้อมูลเดิมก่อน
            const currentDataResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$react$2d$tsx$2d$repair$2d$system$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryRepair"])('SELECT "Rep_info", "Re_Rep1" FROM repairrequest WHERE request_id = $1', [
                id
            ]);
        ...
        if (data.Comment_re !== undefined) {
            // ดึงข้อมูลเดิมก่อน
            const currentCommentResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$react$2d$tsx$2d$repair$2d$system$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryRepair"])('SELECT "Comment_re", "Comment_re2" FROM repairrequest WHERE request_id = $1', [
                id
            ]);
        ...
        let result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$react$2d$tsx$2d$repair$2d$system$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryRepair"])(`UPDATE repairrequest 
       SET ${updates.join(', ')} 
       WHERE request_id = $${paramCount} 
       RETURNING *`, values);
        // If not updated, try with "Request_ID"
        if (result.rows.length === 0) {
            result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$react$2d$tsx$2d$repair$2d$system$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryRepair"])(`UPDATE repairrequest 
         SET ${updates.join(', ')} 
         WHERE "Request_ID" = $${paramCount} 
         RETURNING *`, values);
        }
        ...
        if (newStatus && oldStatus && newStatus !== oldStatus && username) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$react$2d$tsx$2d$repair$2d$system$2f$lib$2f$line$2d$notify$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["notifyStatusChange"])({
                request_id: id,
                username: username,
                oldStatus: oldStatus,
                newStatus: newStatus
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a15f9432._.js.map