...
async function GET(request) {
    try {
        ...
        if (id) {
            ...
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryRepair"])("SELECT * FROM company WHERE id = $1", [
                id
            ]);
            ...
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryRepair"])("SELECT * FROM company ORDER BY company_name ASC");
...
async function POST(request) {
    try {
        ...
        const checkCode = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryRepair"])("SELECT * FROM company WHERE company_code = $1", [
            company_code
        ]);
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryRepair"])(`INSERT INTO company (company_code, company_name, created_at, updated_at) 
       VALUES ($1, $2, NOW(), NOW()) 
       RETURNING *`, [
            company_code,
            company_name
...
async function PUT(request) {
    try {
        ...
        const checkResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryRepair"])("SELECT * FROM company WHERE id = $1", [
            id
        ]);
        ...
        const checkCode = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryRepair"])("SELECT * FROM company WHERE company_code = $1 AND id != $2", [
            company_code,
            id
        ]);
        if (checkCode.rows.length > 0) {
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryRepair"])(`UPDATE company 
...
async function DELETE(request) {
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryRepair"])("DELETE FROM company WHERE id = $1", [
            id
        ]);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ee87c9c0._.js.map