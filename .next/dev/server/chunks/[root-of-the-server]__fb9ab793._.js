...
async function GET(request) {
    try {
        ...
        if (request_id) {
            ...
            result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryRepair"])(`SELECT * FROM feedback WHERE form_name = $1 ORDER BY created_at DESC`, [
                request_id
            ]);
        } else {
            // ดึงข้อมูลทั้งหมด
            result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryRepair"])(`SELECT * FROM feedback ORDER BY created_at DESC`);
        }
...
async function POST(request) {
    try {
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryRepair"])(`INSERT INTO feedback (form_name, form_status, form_description, is_active) 
       VALUES ($1, $2, $3, $4) 
       RETURNING *`, [
            request_id,
            form_status,
        ...
        if (rating < 3) {
            ...
            const commentData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryRepair"])(`SELECT "Comment_re", "Comment_re2" FROM repairrequest WHERE request_id = $1`, [
                request_id
            ]);
            const updates = [];
            const values = [];
            ...
            // Execute UPDATE
            const updateResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["queryRepair"])(`UPDATE repairrequest 
         SET ${updates.join(', ')} 
...
//# sourceMappingURL=%5Broot-of-the-server%5D__fb9ab793._.js.map